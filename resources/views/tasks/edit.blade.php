                ...
                <form method="POST" action="{{ route('tasks.update', $task) }}">
                        ...
                        <div class="col-md-7">
                            <select id="workflow_step_id" class="form-control @error('workflow_step_id') is-invalid @enderror" name="workflow_step_id" required>
                                ...
                                @foreach($workflowSteps as $step)
                                    <option value="{{ $step->id }}" {{ old('workflow_step_id', $task->workflow_step_id) == $step->id ? 'selected' : '' }}>
                                        {{ $step->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7">
                            <select id="priority" class="form-control @error('priority') is-invalid @enderror" name="priority">
                                ...
                                <option value="critical" {{ old('priority', $task->priority) == 'critical' ? 'selected' : '' }}>بحرانی</option>
                            </select>
                            @error('priority')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-7 offset-md-3">
                            ...
                            <a href="{{ route('tasks.show', $task) }}" class="btn btn-danger">
