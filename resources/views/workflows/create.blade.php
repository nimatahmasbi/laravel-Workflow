                ...
                <form method="POST" action="{{ route('workflows.store') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7">
                            <select id="priority" class="form-control @error('priority') is-invalid @enderror" name="priority">
                                <option value="1" {{ old('priority') == 1 ? 'selected' : '' }}>پایین</option>
                                <option value="2" {{ old('priority') == 2 ? 'selected' : '' }}>متوسط</option>
                                <option value="3" {{ old('priority') == 3 ? 'selected' : '' }}>بالا</option>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-7 offset-md-3">
                            ...
                            <a href="{{ route('workflows.index') }}" class="btn btn-danger">
