        ...
        <div class="dashboard-card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 col-sm-6 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h5 class="mb-0">{{ $department->manager_name ?: 'تعیین نشده' }}</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 mb-3">
                        <div class="d-flex align-items-center">
                            <i class="fas fa-toggle-on fa-2x {{ $department->is_active ? 'text-success' : 'text-danger' }} me-3"></i>
                            <div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <p class="mb-0 p-3 bg-light rounded text-overflow-safe">{{ $department->description }}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span class="ms-2 fw-bold text-overflow-safe">{{ $department->phone }}</span>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span class="ms-2 fw-bold text-overflow-safe">{{ $department->email }}</span>
                        </div>
                        @endif
                    </div>
                </div>
