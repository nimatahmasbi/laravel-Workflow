                ...
                <form method="POST" action="{{ route('departments.update', $department) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7">
                            <textarea id="description" class="form-control @error('description') is-invalid @enderror"
                                      name="description" rows="4">{{ old('description', $department->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7">
                            <input id="manager_name" type="text" class="form-control @error('manager_name') is-invalid @enderror"
                                   name="manager_name" value="{{ old('manager_name', $department->manager_name) }}">
                            @error('manager_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-7 offset-md-3">
                            ...
                            <a href="{{ route('departments.show', $department) }}" class="btn btn-danger">
