...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?php echo e(route('departments.show', $department)); ?>" class="btn btn-info me-2">
...
unset($__errorArgs, $__bag); ?>"
                                   name="name" value="<?php echo e(old('name', $department->name)); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>"
                                      name="description" rows="4"><?php echo e(old('description', $department->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                   name="manager_name" value="<?php echo e(old('manager_name', $department->manager_name)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                   name="phone" value="<?php echo e(old('phone', $department->phone)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                   name="email" value="<?php echo e(old('email', $department->email)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-7">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                                       <?php echo e(old('is_active', $department->is_active) ? 'checked' : ''); ?>>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-7 offset-md-3">
                            ...
                            <a href="<?php echo e(route('departments.show', $department)); ?>" class="btn btn-danger">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/hassankhosrojerdi/Desktop/workflow/workflow-system/resources/views/departments/edit.blade.php ENDPATH**/ ?>