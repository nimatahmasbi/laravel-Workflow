...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?php echo e(route('tasks.show', $task)); ?>" class="btn btn-info me-2">
...
unset($__errorArgs, $__bag); ?>"
                                   name="title" value="<?php echo e(old('title', $task->title)); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>" name="workflow_id" required>
                                ...
                                <?php $__currentLoopData = $workflows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workflow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($workflow->id); ?>" <?php echo e(old('workflow_id', $task->workflow_id) == $workflow->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="workflow_step_id" required>
                                ...
                                <?php $__currentLoopData = $workflowSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($step->id); ?>" <?php echo e(old('workflow_step_id', $task->workflow_step_id) == $step->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="assignee_id">
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($user->id); ?>" <?php echo e(old('assignee_id', $task->assignee_id) == $user->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="priority">
                                <option value="low" <?php echo e(old('priority', $task->priority) == 'low' ? 'selected' : ''); ?>>پایین</option>
                                <option value="medium" <?php echo e(old('priority', $task->priority) == 'medium' ? 'selected' : ''); ?>>متوسط</option>
                                <option value="high" <?php echo e(old('priority', $task->priority) == 'high' ? 'selected' : ''); ?>>بالا</option>
                                <option value="critical" <?php echo e(old('priority', $task->priority) == 'critical' ? 'selected' : ''); ?>>بحرانی</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                   name="due_date" value="<?php echo e(old('due_date', $task->due_date ? $task->due_date->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-7 offset-md-3">
                            ...
                            <a href="<?php echo e(route('tasks.show', $task)); ?>" class="btn btn-danger">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/hassankhosrojerdi/Desktop/workflow/workflow-system/resources/views/tasks/edit.blade.php ENDPATH**/ ?>