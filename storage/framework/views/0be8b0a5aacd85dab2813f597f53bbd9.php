            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse" id="sidebar">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <?php if(auth()->user()->canManageDepartments()): ?>
                        <li class="nav-item">
                        ...
                        <?php if(auth()->user()->canManageWorkflows()): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('workflows.*') ? 'active' : ''); ?>" href="<?php echo e(route('workflows.index')); ?>">
                                <i class="fas fa-project-diagram me-2"></i>
                                گردش کارها
                            </a>
                        </li>
...
<?php /**PATH /Users/hassankhosrojerdi/Desktop/workflow/workflow-system/resources/views/layouts/app.blade.php ENDPATH**/ ?>